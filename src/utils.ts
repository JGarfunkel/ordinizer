 ...
 */
export function getEntityId(analysis: Analysis): string {
 ...
 */
export function getDomainId(analysis: Analysis): string {
 ...
 */
export function getQuestionId(analyzedQuestion: AnalyzedQuestion): number | string | undefined {
 ...
 */
export function getStableQuestionKey(id: number | string | undefined): string {
 ...
 */
export function denormalizeAnalysis(analysis: Analysis, entityName?: string, domainName?: string): Analysis {
